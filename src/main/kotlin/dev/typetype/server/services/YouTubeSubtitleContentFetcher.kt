...
internal class OkHttpYouTubeSubtitleContentFetcher(
    ...
    private suspend fun execute(
        ...
        call.enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                val result = runCatching { response.use { readResponse(it, format) } }
    ...
    private fun readResponse(response: Response, format: YouTubeSubtitleFormat): YouTubeSubtitleFetchResult {
    ...
    private companion object {
        const val YOUTUBE_ORIGIN = "https://m.youtube.com"
    }
}
